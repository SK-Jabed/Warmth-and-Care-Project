    ...
    >
      ...
      >
        ...
        <p className="text-lg text-gray-700 leading-relaxed">
          ...
          distribute warm clothing to those in need across Bangladesh. Every //
          winter, thousands of vulnerable people face harsh weather conditions
          // without proper clothing. By donating your unused or gently worn
          winter // clothes, you can bring warmth and comfort to those who need
          it the // most. Together, let's make this winter warmer for everyone!
        </p>
      </div>
    </section>
  );
